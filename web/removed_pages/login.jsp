...
<!-- Mirrored from templates.scriptsbundle.com/knowledge/demo/login.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 22 Feb 2019 07:35:05 GMT -->
<head>
  <meta charset="utf-8">
            ...
            <div class="box-panel">
              ...
              <!-- form login -->
                ...
                <div class="form-group">
                  ...
                  <label>id</label>
                  <input type="text" placeholder="Your id" name="id" class="form-control">
  ...
  <!--footer class="footer-area">
    ...
    <!--div class="footer-copyright">
      <div class="auto-container clearfix">
        <!--Copyright-->
        <div class="copyright text-center">Copyright 2019 &copy; Theme Created By <a target="_blank" href="http://themeforest.net/user/scriptsbundle/portfolio">Scriptsbundle</a> All Rights Reserved</div>
      </div>
    </div>
  </footer>
